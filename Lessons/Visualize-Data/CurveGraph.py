...
# Data
x = np.linspace(0, 10, 48) # 50 points between 0 and 10
...
# Draw the curve
ax.plot(x, y, label='Sin(x)', color='blue', marker='o', markersize=5, markeredgecolor='red', markerfacecolor='red', linewidth=7) # marker='o' adds points on the curve, markersize sets their size
